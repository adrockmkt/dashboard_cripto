...
| SEC-006 | sessão nova em 2026-09-13: requisições same-origin para CoinGecko, Alternative.me e gráfico retornaram 200; console sem erros | O browser não chama mais os provedores diretamente. O gateway Nginx usa destinos fixos, timeout, cache e serve resposta stale em falha transitória. | resolvido | manter destinos allowlisted e revisar cache/limites periodicamente | indisponibilidade prolongada do provedor ainda aciona fallback explicitamente identificado |
